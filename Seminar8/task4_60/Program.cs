...
// Подсмотрела такой метод решения задачи в интернете, но время от время выводится значение 0, хотя пределы 10, 99.
...
//                 if (FindSame(result, temp)) continue;
//                 result[i, j, y] = temp;
//             }
...
// bool FindSame(int[,,] array, int el)
// {
//     for (int i = 0; i < array.GetLength(0); i++)
//     {
//         for (int j = 0; j < array.GetLength(1); j++)
